...
To install osTicket on a Windows 10 Azure VM, first create a virtual machine named osticket-vm with 4 vCPUs, then connect using Remote Desktop. Download and unzip the osTicket-Installation-Files.zip to your desktop. Enable IIS with CGI, install PHP Manager for IIS, and MySQL 5.5.62. <p> 

Install HeidiSQL, connect using root credentials, and create a database named osTicket. Finally, open osTicket in your browser at http://localhost/osTicket/setup/, complete the setup using the database info, and finish installation. <p>
